class Navbar extends HTMLElement {
  ...
  setup() {
    const openBtn = this.shadowRoot!.querySelector(".navbar__open-btn") as HTMLImageElement;
    const closeBtn = this.shadowRoot!.querySelector(".navbar__close-btn") as HTMLImageElement;
    const menu = this.shadowRoot!.querySelector(".navbar__navigation") as HTMLElement;
